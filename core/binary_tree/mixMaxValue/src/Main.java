class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Min value bfs: " + solution.minValueBFS(node_5));
		System.out.println("Max value bfs: " + solution.maxValueBFS(node_5));
		System.out.println("Min value dfs: " + solution.minValueDFS(node_5, Integer.MAX_VALUE));
		System.out.println("Max value dfs: " + solution.maxValueDFS(node_5, Integer.MIN_VALUE));
	}
}
